...
#define prod	"STM32F1 bootloader"
#define serial	"2020.04.15"
#define func	"STM32F1 Serial Port"
#define comm	"STM32F1 COMM"
#define data	"STM32F1 DATA"
...
const usb_device_descriptor deviceDescriptor = {
    ...
    .iSerialNumber = 0, //USB_STRINGS_SERIAL_NUMBER,
...
const cfgDescriptor configDescriptor =
{
	...
	.comm_iface = {
		...
		.iInterface = 0, //USB_STRINGS_COMM,  //  Name of COMM
	},
	...
	.data_iface = {
		...
		.iInterface = 0, //USB_STRINGS_DATA,  //  Name of DATA
	},
		.data_endp_in = {
			.bLength = sizeof(usb_endpoint_descriptor),
			.bDescriptorType = USB_DT_ENDPOINT,
